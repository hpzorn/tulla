    ...
    def build_prompt(self, ctx: PhaseContext) -> str:
        ...
        if research_dir:
            research_instructions = (
                ...
                "   These findings SUPERSEDE the open questions "
                "from D5 — the RQs have been answered.\n"
            )
            research_output_section = (
                ...
                "[how this constrains or informs the architecture]\n"
                "\n"
                "   ## Resolved Blockers\n"
                "   [List blockers from D4 that are now resolved "
                "by research, with the resolution]\n"
            )
        ...
        return (
            ...
            f"{upstream_section}"
            "## Goal\n"
            f"Load and synthesize all discovery documents"
            f"{research_note} into a unified planning context.\n"
            "\n"
            "## Instructions\n"
            "\n"
            "1. Read the original idea: use "
            f"mcp__ontology-server__get_idea with identifier {ctx.idea_id}\n"
            "\n"
            ...
            "   This list becomes the contract for P3 (architecture) "
            "and P4 (implementation plan).\n"
            "\n"
            "   | # | Feature | Source | Priority | Notes |\n"
            "   |---|---------|--------|----------|-------|\n"
            "   | 1 | [Feature name from idea] | [Section in idea] "
            "| P0/P1/P2 | [Any constraints] |\n"
            "   | 2 | ... | ... | ... | ... |\n"
            "\n"
            "   **Total features**: [count]\n"
            "\n"
            "   If the idea mentions \"Key Views\" or similar sections, "
            "EVERY view must appear here.\n"
            "   If the idea mentions optional/future features, "
            "mark them P2+ but still list them.\n"
            "\n"
            ...
            "\n"
            "**IMPORTANT**: The Feature Scope table is the "
            "authoritative list of what this idea delivers.\n"
...
def _extract_section(content: str, heading: str) -> str:
    """Extract content under a ``## heading`` or ``### heading`` until the next heading."""
